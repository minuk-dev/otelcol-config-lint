...
func newVersionCommand() *cobra.Command {
	...
	// Subcommands inherit the root's usage template, whose exit-code footer
	// talks about files passing and failing. This one checks no files.
	cmd.SetUsageTemplate(new(cobra.Command).UsageTemplate())
